    ...
    if (button) {
      button.addEventListener("click", () => {
        if (button.dataset.state === "inactive") {
          ...
          button.className =
            "border-2 border-black h-12 w-40 rounded-xl text-lg  hover:shadow-lg hover:shadow-gray-400 active:border-2 bg-black text-white";
        } else {
          button.dataset.state = "inactive";
          button.className =
            "border-2 border-black h-12 w-40 rounded-xl text-lg active:bg-black active:text-white hover:shadow-lg hover:shadow-gray-400 active:border-white active:border-2 bg-white text-black";
        }
      });
    }
      ...
      <aside className="w-1/3 h-5/6 my-auto flex flex-col justify-evenly content-between px-5">
        <header>
          ...
          <p className=" text-base text-left mb-10 text-[#5E5E5E]  w-96">
            Congratulations on reaching the end of your day! 😊 In order to keep
            improving, we invite you to fill out the form. Your feedback is very
            important to us. Thank you for your time and for being part of this
            experience!
          </p>
        </header>
        ...
        <nav className="mb-12">
          <ul>
            ...
            <li className="my-5">
              ...
              >
                <Image src={IncOut} alt="InBox" className="mr-2" /> Shipments
                Inc&Out
              </Link>
            </li>
            <li className="my-5">
              <Link
                ...
                href="./IncShipments"
              >
                <Image src={IncShip} alt="InBox" className="mr-2" /> Inc.
                Shipments
              </Link>
            </li>
            <li className="my-5">
              <Link
                ...
                href="./IncInspections"
              >
                <Image src={IncIn} alt="InBox" className="mr-2" /> Inc.
                Inspections
              </Link>
            </li>
            <li className="my-5">
              ...
              >
                <Image src={ShipWC} alt="InBox" className="mr-2" /> Shipments
                with courier
              </Link>
            </li>
            <li className="my-5">
        ...
        <footer className="h-fit w-full mb-10">
          <p className="text-[#5e5e5e] text-sm mb-1">Step 1 of 7</p>
          <div className="w-11/12 h-2 rounded-full bg-white">
            <div className="w-2/12 h-full rounded-full bg-[#7B5DE8]"></div>
          </div>
        </footer>
      </aside>
